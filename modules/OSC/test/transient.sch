...
N -610 -280 -610 -230 { lab=#net1}
N -710 -280 -670 -280 { lab=SENS_IN}
N -710 -190 -680 -190 { lab=SENS_IN}
N -630 -280 -610 -280 { lab=#net1}
N -610 -230 -590 -230 { lab=#net1}
...
C {devices/lab_wire.sym} -370 -190 0 0 {name=p1 sig_type=std_logic lab=N2}
C {devices/lab_wire.sym} -370 -230 0 0 {name=p2 sig_type=std_logic lab=N1}
