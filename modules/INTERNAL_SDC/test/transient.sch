...
C {devices/code_shown.sym} 190 -530 0 0 {name=SPICE only_toplevel=false value="
.param VDD = 1.8
.ic v(SENS_IN) = 0
.ic v(REF_IN) = 1.8
.option temp = -40
...
spiceprefix=X
mult=1}
C {devices/code.sym} 740 -710 0 0 {name=MODELS_DIGITAL
only_toplevel=true
...
C {devices/code.sym} 310 -710 0 0 {name=MODELS_TT
only_toplevel=true
spice_ignore=0
format="tcleval( @value )"
value="
...
"}
C {devices/code.sym} 550 -710 0 0 {name=MODELS_FF
only_toplevel=true
spice_ignore=1
format="tcleval( @value )"
value="
...
"}
C {devices/code.sym} 430 -710 0 0 {name=MODELS_SS
only_toplevel=true
spice_ignore=1
format="tcleval( @value )"
value="
