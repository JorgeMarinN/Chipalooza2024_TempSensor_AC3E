...
C {symbol/OSC_v7p1.sym} -80 -270 0 0 {name=XOSC_SENS}
...
C {symbol/OSC_v7p1.sym} -80 20 0 0 {name=XOSC_REF}
...
C {symbol/PASSGATE_v1p2.sym} -100 -340 0 0 {name=XPG}
...
C {symbol/PASSGATE_v1p2.sym} -100 -50 0 0 {name=XPG1}
...
C {symbol/DFF_v4p1.sym} 460 -120 0 0 {name=X1}
